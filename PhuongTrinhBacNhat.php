...
<section>
	<div class="container-fluid">
		<div class="row">
				...
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link" href="SoNguyenTo.php">
							<i class="fa fa-globe fa"></i> Số nguyên tố
						</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="PhuongTrinhBacNhat.php">
							<i class="fa fa-dot-circle"></i> Phương trình bậc nhất
						</a>
					</li>
					<li class="nav-item">
			...
			<div class="col-md">
				<div class="content">
					<p><span class="text-header">Bài toán</span> giải phương trình bậc nhất</p>
					<div class="main-content">
						<form method="get" action="PhuongTrinhBacNhat.php">
							<div class="form-group">
								<input name="a" class="form-control form-input" placeholder="a" value="<?php echo $a; ?>"> x + <input name="b" class="form-control form-input" placeholder="b" value="<?php echo $b; ?>"> = 0
						  </div>
						...
						if(is_numeric($a) && is_numeric($b)){
							...
							echo '
								<div class="error mt-3">
									a hoặc b nhập vào không phải là số
								</div>
							';
						}
					?>
